...
JOB_BASE_FOLDER = "E:/mjolnir_processing/TRAITS_TEST/data"
SELECTED_JOBS = [
    "ZOFE_260521_80_2",
    "ZOFE_260522_80_4",
    "ZOFE_260526_80_1",
...
INPUT_FILENAME = "mosaic_radiance.tif"
...
if __name__ == "__main__":
    for job in SELECTED_JOBS:
        ...
        job_dir = Path(JOB_BASE_FOLDER) / job
        ...
        output_file = job_dir / f"{job_name}_3fld.tif"
